    ...
    >
      <div className="row">
        ...
        <div className="col-12 col-md-6">
          <p>MF GESTIONES cuenta con una experiencia de más de 16 años en el mercado, con una trayectoria brindando servicios de logística urbana desde Villa Allende y sus alrededores a Córdoba Capital desde 2006, aportando soluciones operativas de acuerdo a la necesidad de cada cliente. SOMOS… UNA EXTENSION DE SU EMPRESA.</p>
